...
function SecuritySection() {
    ...
    /** Step 1: Request OTP after user confirms in modal */ const handleRequestOtp = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].error('Failed to send verification code. Please try again.');
            setConfirmOpen(false);
        } finally{
            setSaving(false);
        }
...
function AccountProfileSection() {
    ...
    /** Actually save after user confirms */ const handleConfirmedSave = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"].error('Failed to update profile. Please try again.');
        } finally{
            setSaving(false);
            setConfirmOpen(false);
        }
...
//# sourceMappingURL=src_84a50a._.js.map