        ...
        <table className="w-full text-left border-collapse table-fixed min-w-[800px] lg:min-w-0">
          <thead className="bg-white/50 dark:bg-slate-800/50 border-b border-gray-200 dark:border-slate-700 text-[11px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-wider">
            <tr>
              ...
              <th className="px-6 py-4 w-[18%]">Barangay</th>
              <th className="px-6 py-4 w-[17%]">Status Breakdown</th>
                ...
                <tr key={item.batchId} className="hover:bg-white/60 dark:hover:bg-slate-800/60 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-col gap-1 text-xs">
                      ...
                      {typeof item.summary?.unused === 'number' && (
                        <div className="flex flex-wrap gap-1 text-[10px]">
                          <span className="text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-1.5 py-0.5 rounded font-medium">
                            {item.summary.unused} unused
                          </span>
                          <span className="text-sky-700 dark:text-sky-400 bg-sky-50 dark:bg-sky-950/40 px-1.5 py-0.5 rounded font-medium">
                            {item.summary.used ?? 0} used
                          </span>
                        </div>
                      )}
                    </div>
