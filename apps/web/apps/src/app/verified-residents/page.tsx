      ...
      <section className="mb-6 rounded-[28px] border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 px-5 py-5 sm:px-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">Verification Overview</p>
              <h2 className="mt-2 text-2xl font-bold tracking-[-0.03em] text-slate-950">
                Verified resident summary
              </h2>
            </div>
            <p className="text-sm text-slate-500">Last 7 days {verifiedLast7Days}</p>
          </div>
        </div>
